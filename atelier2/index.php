...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   if ($username === 'admin' && $password === 'secret') {
        $ValauthToken = bin2hex(random_bytes(16));

        setcookie('authToken', $ValauthToken, time() + 3600, '/', '', false, true); // Le Cookie est initialisé et valable pendant 1 heure (3600 secondes) 
